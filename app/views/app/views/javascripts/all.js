...
var GOVUK = function(e) {
    ...
    function(e) {
        "bind"in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
            value: function(t) {
                ...
                for (var p, f = c.call(arguments, 1), m = i(0, d.length - f.length), h = [], b = 0; b < m; b++)
                    u.call(h, "$" + b);
                return p = Function("binder", "return function (" + h.join(",") + "){ return binder.apply(this, arguments); }")(function() {
                    var e;
                    return this instanceof p ? (e = d.apply(this, s.call(f, c.call(arguments))),
                    o(e) === e ? e : this) : d.apply(t, s.call(f, c.call(arguments)))
                }),
    ...
    function(o) {
        ...
        (!("DOMTokenList"in this) || "classList"in (e = document.createElement("x")) && (e.classList.toggle("x", !1) || e.className)) && ("DOMTokenList"in (e = this) && e.DOMTokenList && (!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg") || document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList) || (e.DOMTokenList = function() {
            ...
            return function(i, r) {
                    ...
                    if (n.length)
                        for (t = 0; t < n.length; ++t)
                            if (o.test(n[t]))
                                ...
                                e;
                    for ("" === (s = ("object" == typeof i[r] ? "" + i[r].baseVal : "" + i[r]).replace(/^\s+|\s+$/g, "").split(o))[0] && (s = []),
                    u = {},
                    t = 0; t < s.length; ++t)
                        u[s[t]] = !0;
                    d = s.length,
                ...
                ,
                c.add = function() {
                    l.apply(c, e = arguments);
                    for (var e, t, n = 0, o = e.length; n < o; ++n)
                        u[t = e[n]] || (s.push(t),
                        u[t] = !0);
                    d !== s.length && (d = s.length >>> 0,
    ...
    function(e) {
        ...
        l = Element.prototype = n.appendChild(n.createElement("*")),
        c = {},
        s = function(e, t) {
        ...
        r = 100,
        l.attachEvent("onpropertychange", function(e) {
            for (var t, n = e.propertyName, o = !c.hasOwnProperty(n), i = l[n], r = c[n], a = -1; t = u[++a]; )
                1 !== t.nodeType || !o && t[n] !== r || (t[n] = i);
            c[n] = i
        }),
        l.constructor = Element,
        l.hasAttribute || (l.hasAttribute = function(e) {
        ...
        if (!t) {
            ...
            function p(e, c, s) {
                u(e.prototype, c, function() {
                    var e, t = this, n = "__defineGetter__DEFINE_PROPERTY" + c;
                    if (t[n])
                        return e;
                    if (!(t[n] = !0) === d) {
                        for (var o, i = p.mirror || document.createElement("div"), r = i.childNodes, a = r.length, l = 0; l < a; ++l)
                            if (r[l]._R === t) {
                                o = r[l];
                                break
                            }
                        o = o || i.appendChild(document.createElement("div")),
                        e = DOMTokenList.call(o, t, s)
                    } else
                        e = new DOMTokenList(t,s);
                    return u(t, c, function() {
                        return e
                    }),
                    delete t[n],
                    e
    ...
    function(r) {
        ...
        "createEvent"in document || (window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function() {
            ...
            a._events[e] || (a._events[e] = function(e) {
                ...
                e.pageY = e.clientY + document.documentElement.scrollTop); ++i < r && !e.cancelImmediate; )
                    i in o && -1 !== l(n, t = o[i]) && "function" == typeof t && t.call(a, e)
            }
            ,
            a._events[e].list = [],
        ...
        window.removeEventListener = Window.prototype.removeEventListener = Document.prototype.removeEventListener = Element.prototype.removeEventListener = function() {
            ...
            t._events && t._events[n] && t._events[n].list && -1 !== (e = l(t._events[n].list, arguments[1])) && (t._events[n].list.splice(e, 1),
    ...
    ,
    i.prototype.focusTarget = function(e) {
    ...
    ,
    i.prototype.getFragmentFromUrl = function(e) {
        return -1 !== e.indexOf("#") && e.split("#").pop()
    }
    ,
    i.prototype.getAssociatedLegendOrLabel = function(e) {
    ...
    ,
    a.prototype.syncConditionalRevealWithInputState = function(e) {
    ...
    var m = "http://www.w3.org/1999/xhtml"
      ...
      , u = !!N && N.createRange && "createContextualFragment"in N.createRange();
    function h(e) {
        return e = e.trim(),
        s ? (t = e,
        (n = N.createElement("template")).innerHTML = t,
        n.content.childNodes[0]) : u ? (t = e,
        c || (c = N.createRange()).selectNode(N.body),
        c.createContextualFragment(t).childNodes[0]) : (n = e,
        (e = N.createElement("body")).innerHTML = n,
        e.childNodes[0]);
        var t, n
    }
    function C(e, t) {
    ...
    _ = function(e, t) {
        ...
        if (11 !== t.nodeType && 11 !== e.nodeType) {
            ...
            for (var c = e.attributes, s = c.length - 1; 0 <= s; s--)
                o = (n = c[s]).name,
    ...
    var f = {
        morphdom: function(e, t, n) {
            ...
            (t = N.createElement("html")).innerHTML = i) : t = h(t));
            var g = n.getNodeKey || y
              , w = n.onBeforeNodeAdded || b
              , E = n.onNodeAdded || b
              , L = n.onBeforeElUpdated || b
              , A = n.onElUpdated || b
              , o = n.onBeforeNodeDiscarded || b
              , r = n.onNodeDiscarded || b
              , k = n.onBeforeElChildrenUpdated || b
              , i = !0 === n.childrenOnly
            ...
            function j(e, t, n) {
                ...
                if ("TEXTAREA" !== e.nodeName) {
                    var i, r, a, l, c, s, u = e, o = t, d = o.firstChild, p = u.firstChild;
                    e: for (; d; ) {
                        for (l = d.nextSibling,
                        i = g(d); p; ) {
                            if (a = p.nextSibling,
                            ...
                            var f = p.nodeType
                              , m = void 0;
                            if (f === d.nodeType && (1 === f ? (i ? i !== r && (!(c = T[i]) || a === c ? m = !1 : (u.insertBefore(c, p),
                            r ? S(r) : x(p, u, !0),
                            p = c)) : r && (m = !1),
                            (m = !1 !== m && C(p, d)) && j(p, d)) : 3 !== f && 8 != f || (m = !0,
                        ...
                        i && (c = T[i]) && C(c, d) ? (u.appendChild(c),
                        j(c, d)) : !1 !== (s = w(d)) && ((d = s ? s : d).actualize && (d = d.actualize(u.ownerDocument || N)),
                        u.appendChild(d),
                        function e(t) {
                            E(t);
                            for (var n = t.firstChild; n; ) {
                                var o = n.nextSibling
                                  , i = g(n);
                                (i = i && T[i]) && C(n, i) ? (n.parentNode.replaceChild(i, n),
                                j(i, n)) : e(n),
                                n = o
                            }
                        }(d)),
            ...
            var l, c, n = e, s = n.nodeType, u = t.nodeType;
            if (!i)
                if (1 === s)
                    1 === u ? C(e, t) || (r(e),
                    n = function(e, t) {
                    ...
                    (c = t.namespaceURI) && c !== m ? N.createElementNS(c, l) : N.createElement(l)))) : n = t;
                else if (3 === s || 8 === s) {
                    if (u === s)
            ...
            if (n === t)
                ...
                a)
                    for (var d = 0, p = a.length; d < p; d++) {
                        var f = T[a[d]];
                        f && x(f, f.parentNode, !1)
                    }
            }
            return !i && n !== e && e.parentNode && (n.actualize && (n = n.actualize(e.ownerDocument || N)),
    ...
    return e.Frontend = {
        ...
        initAll: function(e) {
            ...
            p(e.querySelectorAll('[data-module="govuk-details"]'), function(e) {
                new o(e).init()
            }),
            new r(e.querySelector('[data-module="govuk-header"]')).init(),
            p(e.querySelectorAll('[data-module="govuk-radios"]'), function(e) {
                new a(e).init()
            }),
            p(e.querySelectorAll('[data-module="govuk-skip-link"]'), function(e) {
                new l(e).init()
            }),
            new i(e.querySelector('[data-module="govuk-error-summary"]')).init()
        }
    },
    e.vendor = f,
    e
...
!function(a) {
    ...
    function l(t, s, a, e) {
        ...
        "hidden" !== document.visibilityState && 1 === a.push(t) && $.ajax(s, {
            ...
            for (var s = a, e = t; s.length; )
                s.shift()(e);
            1 === t.stop ? window.clearTimeout(o) : f = c(Date.now() - i)
        }).fail(function(t) {
    ...
    a.GOVUK.NotifyModules.UpdateContent = function() {
        this.start = function(t) {
            ...
            f = 2e3,
            t.replaceWith(o),
            void 0 !== o.data("classesToPersist") && o.data("classesToPersist").split(" ").forEach(function(t) {
    ...
    ,
    a.GOVUK.NotifyModules.UpdateContent.calculateBackoff = c
}(window);
"use strict";
!function(t) {
    var e = []
...
"use strict";
window.GOVUK.NotifyModules.LiveCheckboxControls = function() {
    var e = this;
    this.start = function(t) {
        var e = this;
        this.$form = $(t),
        ...
        this.states.filter(function(t) {
            return "nothing-selected-hint" === t.key
        }).forEach(function(t) {
            return e.onNothingSelected(t)
        }),
        this.states.filter(function(t) {
            return "items-selected-hint" === t.key
        }).forEach(function(t) {
            return e.onSomethingSelected(t)
        }),
        ...
        this.$form.on("change", "input[type=checkbox]", function() {
            return e.onCheckboxChanged()
        })
    }
    ,
    this.onNothingSelected = function(t) {
        var e = this
          , n = this.makeActionButton("Select all", {
            onclick: function() {
                e.$form.find("input:checkbox").prop("checked", !0),
                e.$form.find("input:checkbox").eq(0).focus(),
                e.showInitialState()
            },
            nonvisualText: "".concat(this.thing.plural)
        });
        t.$el.find(".checkbox-list-selected-counter").append(n)
    }
    ,
    this.onSomethingSelected = function(t) {
        var e = this
          , n = this.makeActionButton("Clear", {
            onclick: function() {
    ...
    this.selectionStatus = {
        default: function() {
            return "No ".concat(e.thing.plural, " selected")
        },
        selected: function(t) {
            return 1 === t ? "1 ".concat(e.thing.singular, " selected") : "".concat(t, " ").concat(e.thing.plural, " selected")
        },
        update: function(t) {
            t = 0 < t ? e.selectionStatus.selected(t) : e.selectionStatus.default;
            $(".checkbox-list-selected-counter__count").html(t),
            e.$liveRegionCounter.html(t)
        }
    },
    this.makeActionButton = function(t, e) {
        t = $('<a href=""></a>').html(t).addClass("govuk-link govuk-link--no-visited-state js-action").attr("tabindex", "0").on("click keydown", function(t) {
    ...
    this.onCheckboxChanged = function() {
        ...
        "nothing-selected-hint" === this.currentState && 0 !== t ? this.currentState = "items-selected-hint" : "items-selected-hint" === this.currentState && 0 === t && (this.currentState = "nothing-selected-hint"),
        this.stateHasChanged() && this.render(),
...
"use strict";
!function(n) {
    n.AddBrandingOptionsForm = function() {
        n.LiveCheckboxControls.call(this),
        this.onNothingSelected = function(n) {}
    }
}(window.GOVUK.NotifyModules);
"use strict";
!function(o) {
    o.SetAuthTypeForm = o.LiveCheckboxControls
}(window.GOVUK.NotifyModules);
"use strict";
!function() {
    var e = window.GOVUK;
...
window.GOVUK.ErrorBanner = {
    hideBanner: function() {
        return $(".govuk-error-summary").addClass("govuk-!-display-none")
    },
    showBanner: function() {
        return $(".govuk-error-summary").removeClass("govuk-!-display-none").trigger("focus")
    }
};
"use strict";
...
$(function() {
    return $(".govuk-header__container").on("click", function() {
